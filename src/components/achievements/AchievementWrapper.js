...
const AchievementWrapper = () => {
  const { achievement } = useSelector(({ user }) => user) ?? {};
  ...
  const items = [
    ...
    {
      id: 2,
      icon: <IconGamePad className="w-[128px] max-h-[128px] mx-auto" />,
      value: count || 0,
