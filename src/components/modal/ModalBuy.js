...
const ModalBuy = () => {
  ...
  return (
    <BoxModal className="fixed h-[100vh] w-full z-[60] text-white bg-[#00000073] flex-center">
      <div
        ref={modal_ref}
        className={`duration-${DURATION} transition-all opacity-5 scale-90 h-fit min-w-[540px] w-fit border-[5px] border-[#F472B6] rounded-[30px] flex flex-col bg-gradient-to-b from-[#570426] to-[#270010] px-[30px] py-[20px] max-[576px]:min-w-[90%] max-[576px]:w-[90%] max-[576px]:h-[60vh] overflow-y-scroll modal-scroll`}
      >
        ...
        <div className="flex flex-col items-center ">
          ...
          <div className="flex-center flex-col ">
            ...
            <button
              ...
              ${
                loading !== STATUS.NOT_START || zera < payload?.item?.price
                  ? ""
                  : "hover:bg-violet-700"
              }
              `}
