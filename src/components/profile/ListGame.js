    ...
    <div className="bg-[#00000080] rounded-[20px]">
      <>
        ...
        <div className="rounded-t-[20px] bg-[#EC4899] py-[16px] pl-[16px] text-[28px] font-bold relative max-[730px]:w-full max-[500px]:flex max-[500px]:justify-between">
          <div
            className="flex items-center text-2xl cursor-pointer max-[551px]:text-lg"
            onClick={() => {
              setIsOpenTab(false);
            }}
          >
          ...
          <div className="absolute top-[50%] left-[50%] min-[500px]:translate-x-[-50%] min-[500px]:translate-y-[-50%] max-[500px]:static max-[500px]:pr-[16px] max-[551px]:text-lg">
        ...
        {payload === "PURCHASE_HISTORY" ? (
            ...
            <>
              {listGame?.avatar?.length > 0 && (
                <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-4 max-[1140px]:grid-cols-3 max-[730px]:grid-cols-2 max-[551px]:grid-cols-1 gap-x-9 max-[1718px]:gap-x-2">
          ...
          <div>
            {listGame?.length ? (
              <div className="p-[45px] max-[730px]:p-2 flex flex-wrap max-[459px]:px-1 gap-4 overflow-auto max-h-[500px] modal-scroll">
                {listGame?.map((e, i) => (
                  <div key={i}>
                    <GameItem
