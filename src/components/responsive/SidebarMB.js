...
const SidebarMB = ({ className, childClassName }) => {
  ...
  const openSidebar = () => {
    ...
    sidebarRef.current?.classList.add("z-50");
  ...
  return (
    <div className="relative hidden max-[991px]:block" ref={wrapperRef}>
        ...
        >
          <div className="p-3 pb-[6px]">
            ...
            <div className="text-violet-300 flex items-center justify-between">
              <IconMenu className="w-8 h-8" onClick={openSidebar} />
              <IconSearch
      ...
      <div className="relative">
        {isMatchTabletMobile && (
          <SideBar
            className="invisible rounded-2xl max-[991px]:block fixed-imp top-4 backdrop-blur-[10px] opacity-0 transition-all"
