...
const CoverPageItem = ({ isOwner }) => {
  return (
    <div className="bg-pink-900 border border-pink-400 rounded-[30px] p-2.5">
      <img
        src="https://images.unsplash.com/photo-1676313753526-4268df8ddda1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
        alt=""
